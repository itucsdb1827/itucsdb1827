...
INIT_STATEMENTS = [
	...
	"ALTER TABLE messsages DROP CONSTRAINT  messages_clan_id_fkey CASCADE",
	"ALTER TABLE messsages DROP CONSTRAINT  messages_replyof_fkey CASCADE",
	"ALTER TABLE messsages DROP CONSTRAINT  messages_user_id_fkey CASCADE",
